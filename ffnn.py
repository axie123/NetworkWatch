...
import numpy as np
from training import running_metrics, dump_into_transferfile
...
model_eval.model_evals['testing_loss'] = test_losses

dump_into_transferfile(model_eval.model_evals)
